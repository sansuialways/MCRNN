...
dataset = 'foa'     # ['foa', 'mic']
feat = 'mel'    # ['mel', 'stft']
normal_feature_path = '/home/zhangkeming/dcase2019/task3-dataset/feat_label_{}/{}_dev_norm'.format(feat ,dataset)
label_path = '/home/zhangkeming/dcase2019/task3-dataset/feat_label_{}/{}_dev_label'.format(feat ,dataset)
write_feature_path = '/home/zhangkeming/dcase2019/task3-dataset/feat_label_{}/{}_dev_norm'.format(feat ,dataset)
write_label_path = '/home/zhangkeming/dcase2019/task3-dataset/feat_label_mel/{}_dev_label'.format(dataset)
channel=4
...
for file_cnt, file_name in enumerate(filenames_list):
    ...
    for j in range(augment_num):
        for i in range(3):  
            ...
            np.save(os.path.join(write_label_path, 'split' + str(new_split[split_num-1]) + file_inter+str(new_file_num)+'.npy'), label_file)
